    ...
    return (
        <div className="settings-stack">
            ...
            <Card>
                ...
                <CardSection
                    title="Overlay"
                    hint={<>HTML file served at <code>/game</code> for the OBS browser source.</>}
                >
                ...
                <CardSection
                    title="Game packs"
                    hint={<>One folder per game (e.g. <code>melee/</code>, <code>pplus/</code>) with character art and <code>game.json</code>.</>}
                >
                    <label className="settings-field">
            ...
            <Card>
                ...
                <label className="settings-field">
                    ...
                    <span className="settings-hint">
                        Personal token used by Pick Set. Stored locally in <code>streamfighter.secrets.json</code> (mode 0600).
                    </span>
                </label>
            </Card>
        </div>
