...
export default function OverlayEditor({
  ...
  const set = (patch: Partial<OverlayAppearance>) =>
    ...
    <div className="settings-stack">
      <Card>
            ...
            <label className="settings-field">
              ...
              <div className="color-row">
                <input
                  ...
                  value={value.accent}
                  onInput={(e) =>
                    set({ accent: (e.target as HTMLInputElement).value })
                  }
                  onBlur={() => commit()}
                />
                <input
            ...
            <label className="settings-field">
              ...
              <div className="color-row">
                <input
                  ...
                  onInput={(e) =>
                    set({ sidebarBg: (e.target as HTMLInputElement).value })
                  }
                  onBlur={() => commit()}
                />
                <input
        ...
        <CardSection
          ...
          hint={
            <>
              Picks the font and size used for tags and round labels in the
              overlay.
            </>
          }
        >
          ...
          <div className="overlay-slider-grid">
            <div className="slider-row">
              ...
              <input
                ...
                onChange={(e) =>
                  onSlide({ nameFontSize: Number(e.target.value) })
                }
              />
            </div>
            <div className="slider-row">
              ...
              <input
                ...
                onChange={(e) =>
                  onSlide({ roundFontSize: Number(e.target.value) })
                }
              />
            </div>
          </div>
