...
export const ICONS = {
  ...
  twitch: {
    viewBox: "0 0 24 24",
    d: [
      "M11.571 4.714h1.715v5.143h-1.715zm4.715 0H18v5.143h-1.714zM6 0L1.714 4.286v15.428h5.143V24l4.286-4.286h3.428L22.286 12V0zm14.571 11.143l-3.428 3.428h-3.429l-3 3v-3H6.857V1.714h13.714Z",
    ],
  },
  discord: {
    viewBox: "0 0 24 24",
  ...
  copy: {
    viewBox: "0 0 16 16",
    d: [
      "M0 6.75C0 5.784.784 5 1.75 5h1.5a.75.75 0 010 1.5h-1.5a.25.25 0 00-.25.25v7.5c0 .138.112.25.25.25h7.5a.25.25 0 00.25-.25v-1.5a.75.75 0 011.5 0v1.5A1.75 1.75 0 019.25 16h-7.5A1.75 1.75 0 010 14.25z",
      "M5 1.75C5 .784 5.784 0 6.75 0h7.5C15.216 0 16 .784 16 1.75v7.5A1.75 1.75 0 0114.25 11h-7.5A1.75 1.75 0 015 9.25zm1.75-.25a.25.25 0 00-.25.25v7.5c0 .138.112.25.25.25h7.5a.25.25 0 00.25-.25v-7.5a.25.25 0 00-.25-.25z",
    ],
  },
  open: {
    viewBox: "0 0 16 16",
        ...
        ${casters.map((c, i) => {
          ...
          return html`
            <div class="caster-row" key=${i}>
              ...
              ${pronouns &&
              html`<span class="caster-pronouns">${pronouns}</span>`}
              ${socials.length > 0 &&
              html`
...
export function TournamentName({ name }) {
  if (!name) return null;
  return html` <div class="tournament-name">${name.toUpperCase()}</div> `;
}
